<template>
  <label class="checkbox" :class="{ checked: checked }" @click.stop.prevent="change">
    <span class="icon">
      ...
      <svg v-if="checked" t="1587976064214" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="4734" width="14" height="14" xmlns:xlink="http://www.w3.org/1999/xlink">
        <path
